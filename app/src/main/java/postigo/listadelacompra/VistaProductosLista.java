...
public class VistaProductosLista extends AppCompatActivity implements View.OnClickListener{
    ...
    private String datosProducto_id_producto;
    ...
    public static final String URL_CREAR_PRODUCTO = "http://antoniopostigo.es/Slim2-ok/api/anadir/producto";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datosProducto_id_producto= getIntent().getStringExtra("ID_LISTA");
        ...
        cogerProductos(datosProducto_id_producto);
        ...
        lista_productos.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                //Toast.makeText(getApplicationContext(), "->"+lista.getId_lista(), Toast.LENGTH_SHORT).show();
            }
        });
    }
                ...
                try {
                    ...
                    if (!edt_nom_pro.getText().toString().isEmpty()){
                        if (!edt_pro_cant.getText().toString().isEmpty()){
                            cant_pro = Integer.parseInt(edt_nom_pro.getText().toString());
                        }
                        crearProducto(edt_nom_pro.getText().toString(), cant_pro);
                    }
    ...
    private void crearProducto(String nombre_producto, int cantidad_producto) {
